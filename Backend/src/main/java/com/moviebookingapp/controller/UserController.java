...
//		
//	logger.info("register as new user");
...
//	public ResponseEntity<?> login(@PathVariable String userName, @PathVariable String userPassword){
//		boolean result=userService.authenticate(userName, userPassword);
//	logger.info("logged in process");
